                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="departamento" name="departamento" required class="form-control">
                            ...
                            <option value="TI" <?php echo (($_POST['departamento'] ?? '') === 'TI') ? 'selected' : ''; ?>>TI - Tecnologia da Informação</option>
                            <option value="RH" <?php echo (($_POST['departamento'] ?? '') === 'RH') ? 'selected' : ''; ?>>RH - Recursos Humanos</option>
                            <option value="ADM" <?php echo (($_POST['departamento'] ?? '') === 'ADM') ? 'selected' : ''; ?>>ADM - Administrativo</option>
                            <option value="FIN" <?php echo (($_POST['departamento'] ?? '') === 'FIN') ? 'selected' : ''; ?>>FIN - Financeiro</option>
                            <option value="COM" <?php echo (($_POST['departamento'] ?? '') === 'COM') ? 'selected' : ''; ?>>COM - Comercial</option>
                            <option value="MKT" <?php echo (($_POST['departamento'] ?? '') === 'MKT') ? 'selected' : ''; ?>>MKT - Marketing</option>
                            <option value="OPE" <?php echo (($_POST['departamento'] ?? '') === 'OPE') ? 'selected' : ''; ?>>OPE - Operações</option>
                            <option value="LOG" <?php echo (($_POST['departamento'] ?? '') === 'LOG') ? 'selected' : ''; ?>>LOG - Logística</option>
                        </select>
                    </div>
