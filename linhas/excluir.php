...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmar'])) {
    ...
    if (salvarArquivoJSON('../data/linhas.json', $linhas)) {
        $_SESSION['mensagem'] = 'Linha excluída com sucesso!';
        $_SESSION['mensagem_tipo'] = 'success';
        header('Location: index.php');
        exit;
    } else {
        $mensagem = 'Erro ao excluir a linha. Tente novamente.';
        $tipoMensagem = 'error';
    }
}
?>
...
<main class="main-container">
    <div class="page-header">
        <div>
            <h1><i class="fas fa-trash-alt"></i> Excluir Linha</h1>
            <p class="page-subtitle">Confirme a exclusão da linha telefônica</p>
        </div>
    ...
    <div class="confirmation-card">
        ...
        <div class="info-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item"><span class="info-label">Status:</span><span class="info-value"><?php echo getStatusLinhaTexto($linhaAtual['status']); ?></span></div>
            </div>
        </div>
        ...
        <div class="warning-card">
            ...
            <p>Esta ação não pode ser desfeita. A linha será permanentemente removida do sistema.</p>
        </div>
